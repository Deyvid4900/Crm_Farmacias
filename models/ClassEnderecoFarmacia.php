...
{
    protected $table = 'enderecosFarmacia';
    ...
    // Métodos de CRUD
    public function insertArray(array $data, $idFarmacia)
{
    $sql = "INSERT INTO $this->table 
      (Farmacia_id, logradouro, numeroCasa, bairro, complemento, cidade, uf, referencia) 
      VALUES 
      (:Farmacia_id, :logradouro, :numeroCasa, :bairro, :complemento, :cidade, :uf, :referencia)";

    $stmt = Database::prepare($sql);
    $stmt->bindParam(':cliente_id', $idFarmacia);
