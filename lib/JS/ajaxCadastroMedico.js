...
$(document).ready(function () {
    ...
    $('#cel1').inputmask('(99) 9999-9999');
    $('#cel2').inputmask('(99) 9999-9999');
    $('#tel1').inputmask('(99) 9999-9999');

    $('#MedicoForm').submit(function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: '/controllers/controllerMedicoCadastro.php', // Substitua com o caminho real do seu controlador PHP
            data: formData,
            beforeSend: function () {
