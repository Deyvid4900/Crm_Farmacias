$(document).ready(function () {
    ...
    $('#formUpdateConfig').submit(function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: '/controllers/controllerConfigFarmacia.php', // Substitua com o caminho real do seu controlador PHP
            data: formData,
            beforeSend: function () {
            ...
            success: function (data) {
                ...
                } else if (data == "Não foi possivel atualizar os dados") {
                    console.log(data);
                    $('#resultado').html(data);
                    containerAlerta.css({
                        "width": "375px",
