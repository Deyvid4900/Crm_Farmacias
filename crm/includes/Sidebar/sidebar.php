...
<section class="sideBar-bg">
    <div class="childSidebar-bg">
        <div class="teste sd">
            <div class="Cadastro testi " data-menu>
                <a href="" class="addSeta">
        ...
        <div class="testeDown sd">
            <div class="Consultorio" data-menu>
                <a href="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-clipboard-pulse" viewBox="0 0 16 16">
    ...
    <div class="settings sd">
        <div class="lastPad" data-menu>
            <a href="">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-gear-wide-connected" viewBox="0 0 16 16">
...
<section>
    <div class="sideBar-info">
        <div class="boxCadastro" id="linkCLiente">
            <p>
                <i href="">Clientes</i>
            </p>
        </div>
...
<section>
    <div class="sideBar-infoMarketing">
        <div class="boxMarketing">
            <p><a href="">Filtros <br> Livres</a></p>
        </div>
        <div class="boxMarketing">
            <p><a href="">SMS</a></p>
        </div>
        <div class="boxMarketing">
            <p><a href="">E-Mails</a></p>
        </div>
        <div class="boxMarketing">
            <p><a href=""> Corres-pondência</a></p>
        </div>
    </div>
</section>
